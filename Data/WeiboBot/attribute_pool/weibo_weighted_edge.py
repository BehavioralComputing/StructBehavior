...
class WeightedEdge:
    ...
    def run(self):
        ...
        dgl.save_graphs(os.path.join(BASE_DIR, "weibo_weighted_graph.dgl"), new_graph)
        print("Weighted graph saved to 'weibo_weighted_graph.dgl'.")


if __name__ == "__main__":
    g = dgl.load_graphs("Weibo_Data_hetero_graph.dgl")[0][0]
