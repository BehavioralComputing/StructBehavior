...
class BotRGCN(nn.Module):
    def __init__(self, args):
        ...
        self.linear_relu_num_prop = nn.Sequential(
            nn.Linear(self.num_prop_size, int(input_dimension / 3)),
            nn.LeakyReLU())
        self.linear_relu_cat_prop = nn.Sequential(
            nn.Linear(self.cat_prop_size, int(input_dimension / 3)),
            nn.LeakyReLU())
        self.linear_relu_post_prop = nn.Sequential(
            nn.Linear(self.post_prop_size, int(input_dimension / 3 + 2)),
            nn.LeakyReLU())
    ...
    def forward(self, data, return_attention=False):
        ...
        cat_prop = x[:,
                     ...
                     self.cat_prop_size]
        post_prop = x[:,
                      self.num_prop_size + self.cat_prop_size:]
...
class Trainer(object):
    ...
    def load_data(self):
        ...
        tree_path = os.path.join(
            PWD, 'Data', 'WeiboBot', 'attribute_tree', 'trees',
        ...
        # Layer2 Data
        attribute_pool_graph_path = os.path.join(PWD, 'Data/WeiboBot/attribute_pool/weibo_weighted_graph.dgl')
        ...
        map_data_path = os.path.join(PWD, 'Data/WeiboBot/attribute_pool/weibo_data_df.csv')
        ...
        x = torch.cat([
            torch.load(os.path.join(whole_raw_path, 'weibo_num_properties_tensor.pt')),
            torch.load(os.path.join(whole_raw_path, 'weibo_cat_properties_tensor.pt')),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha_2_3', type=float, default = 0.12)
